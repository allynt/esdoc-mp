...
def _component():
    ...
    return {
        ...
        'properties' : [
            ('children', 'software.component', '0.N', None),
            ('citation_list', 'shared.citation', '0.N', None),
            ('citations', 'shared.citation', '0.N', None),
            ...
            ('language', 'software.component_language', '0.1', None),
            ...
            ('parent', 'software.component', '0.1', None),
            ...
            ('property_tree', 'software.component_property', '0.N', 'The properties that this model simulates and/or couples.'),
        ...
        'decodings' : [
            ('children', 'child::cim:childComponent/cim:modelComponent', 'software.model_component'),
            ('children', 'child::cim:childComponent/cim:processorComponent', 'software.processor_component'),
            ('citation_list', 'child::cim:citation'),
            ('citations', 'child::cim:citation'),
            ('description', 'child::cim:description'),
            ...
            ('property_tree', 'child::cim:componentProperties/cim:componentProperty'),
            ('property_tree', 'child::cim:scientificProperties/cim:componentProperty'),
            ('property_tree', 'child::cim:numericalProperties/cim:componentProperty'),
